...
Fuel = TypedDict('Fuel', {"id": int, "company_name": str,
                          "fuel_name": str, "fuel_price": str, "fuel_type": str})
...
def get_socar_fuels():
    db = connect_db()
    response = requests.get("https://www.sgp.ge/en/",
    ...
    for li in soup.find_all("li", attrs={"data-percent": True}):
        ...
        fuel_price: str = li.find("div", attrs={
                                  "class": "counter counter-inherit counter-instant"}).text.split("  ")[0].strip()
